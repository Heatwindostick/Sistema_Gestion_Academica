    ...
    public partial class frmAsignarDocente : Form
    {
        ...
        private void frmAsignarDocente_Load(object sender, EventArgs e)
        {
            ...
            if (cbonivel.Items.Count > 0)
            {
                ...
                cbogradoseccion.Items.Add(new ComboBoxItem() { Value = 0, Text = "Seleccione Aula" });
        ...
        private void CargarDatos()
        {
            ...
            if (idgradoseccion == 0)
            {
                MessageBox.Show("Debe seleccionar un aula", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
