    ...
    public partial class frmCrearGradoSeccion : Form
    {
        ...
        private void CargarDatos()
        {
            ...
            if (oListaGradoSeccion.Count > 0)
            {
                ...
                tabla.Columns.Add("Aula", typeof(string));
                tabla.Columns.Add("Número de Aula", typeof(string));
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvdata.SelectedRows.Count > 0)
            {
                ...
                txtdescripciongrado.Text = dgvdata.Rows[index].Cells["Aula"].Value.ToString();
                txtdescripcionseccion.Text = dgvdata.Rows[index].Cells["Número de Aula"].Value.ToString();
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            if (dgvdata.SelectedRows.Count > 0)
            {
                DataGridViewRow currentRow = dgvdata.SelectedRows[0];
                int index = currentRow.Index;
                if (MessageBox.Show("¿Desea eliminar el Aula '" +
                    dgvdata.Rows[index].Cells["Aula"].Value.ToString() + " - "+
                    dgvdata.Rows[index].Cells["Número de Aula"].Value.ToString() +
